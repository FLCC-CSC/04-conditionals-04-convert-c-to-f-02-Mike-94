...
# NAME: Michael Reed
# DATE: 2/22/2026
# BRIEF DESCRIPTION: Converting_C_to_F  
...
if choice == 1:
  ...
  print()
  print(f"{Fahrenheit: .1f} degrees Fahrenheit is{Celsius: .1f} degrees Celsius.")
...
I learned about the formulas to convert C to F, F to C. As well as spacing is everything.
